...
f = open('temp2.txt','w+')
words = {}
for word in sorted(keywordsHs1.keys()):
    words[word]=1
    
for word in sorted(keywordsHs2.keys()):
    words[word]=1

for word in sorted(keywordsHs3.keys()):
    words[word]=1

for word in sorted(keywordsHs4.keys()):
    words[word]=1

for word in sorted(keywordsHs5.keys()):
    words[word]=1
